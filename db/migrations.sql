...
\c car_finder
CREATE TABLE saved_cars (id SERIAL PRIMARY KEY, plate varchar(255), state varchar(255), make varchar(255), model varchar(255), style varchar(255), color varchar(255) );
